            ...
            <div class="product-agileinfo-grids w3l">
                <div class="col-md-3 product-agileinfo-grid">
                    ...
                    <div class="price">
                        ...
                        <script type=" {{ asset('/')}}font/text/javascript" src="js/jquery-ui.js"></script>
                    </div>
                    <div class="top-rates">
                                                ...
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    ...
                                                    <div class="grid-arr">
                                                        <div  class="grid-arrival">
                                                            <figure>
                                                                <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                                                                    <div class="grid-img">
                                                                        <img  src="{{asset('product-image/'.$product->product_image)}}" class="img-responsive" alt="">
                                                                    </div>
                                                                    <div class="grid-img">
                                                                        <img  src="{{asset('product-image/'.$product->product_image)}}" class="img-responsive"  alt="">
                                                                    </div>
                                                        ...
                                                        <div class="women">
                                                            ...
                                                            <p ><em class="item_price">taka-{{ $product->product_price}}</em></p>
